...
class Gonzales(Bot):
    ...
    def __init__(self,
                 ...
                 *,
                 ...
                 speed_limit_offset=SPEED_LIMIT_OFFSET,
        ...
        self._speed_limits = [
            ...
            self._speed_limit_offset for p in self._track
        ]
    ...
    def _optimizeTrack(self):
        ccf = [
            self._corner_cut_factor if p.is_apex() else 0
    ...
    def _goFast(self, wp, pos, velocity):
        ...
        while md > d:
            ...
            if tv < v:
                ts = (v - tv) / -self._effective_deceleration
                td = ts * (tv + v) / 2
                if td > d:
                    throttle = -1
    ...
    def _inTheRightDirection(self, wp, pos, velocity):
        ...
        if DEBUG: self._last_steer_wp = target.index
